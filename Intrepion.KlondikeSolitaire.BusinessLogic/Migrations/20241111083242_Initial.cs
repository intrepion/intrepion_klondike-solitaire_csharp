        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Players_AspNetUsers_ApplicationUserUpdatedById",
                        column: x => x.ApplicationUserUpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ranks_AspNetUsers_ApplicationUserUpdatedById",
                        column: x => x.ApplicationUserUpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                        .Annotation("SqlServer:IsTemporal", true)
                        .Annotation("SqlServer:TemporalHistoryTableName", "SuitsHistory")
                        .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                        .Annotation("SqlServer:TemporalPeriodStartColumnName", "PeriodStart"),
                    ApplicationUserUpdatedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Suits_AspNetUsers_ApplicationUserUpdatedById",
                        column: x => x.ApplicationUserUpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RankId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                        ...
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                        .Annotation("SqlServer:TemporalPeriodStartColumnName", "PeriodStart"),
                    SuitId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                        .Annotation("SqlServer:IsTemporal", true)
                        .Annotation("SqlServer:TemporalHistoryTableName", "CardsHistory")
                        .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cards_AspNetUsers_ApplicationUserUpdatedById",
                        column: x => x.ApplicationUserUpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cards_ApplicationUserUpdatedById",
                table: "Cards",
                column: "ApplicationUserUpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Players_ApplicationUserUpdatedById",
                table: "Players",
                column: "ApplicationUserUpdatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Ranks_ApplicationUserUpdatedById",
                table: "Ranks",
                column: "ApplicationUserUpdatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Suits_ApplicationUserUpdatedById",
                table: "Suits",
                column: "ApplicationUserUpdatedById");
