...
[TestFixture]
public partial class PuzzleAdminPages : PageTest
{
    [Test]
    public async Task MainNavigation()
    {
        ...
        await Page.GetByTestId("puzzleNavLink").ClickAsync();
        await Expect(Page).ToHaveTitleAsync("Puzzle Home");
        await Page.GetByRole(AriaRole.Link, new() { Name = "Create New" }).ClickAsync();
        await Expect(Page).ToHaveTitleAsync("Puzzle Add");

        await Page.GetByLabel("Description:", new() { Exact = true }).FillAsync("aDescription" + aRandomString);
        ...
        await Page.GetByLabel("Publish Time:", new() { Exact = true }).FillAsync("2011-01-01");
        // CreatePropertyCodePlaceholder

        await Page.GetByRole(AriaRole.Button, new() { Name = "Submit" }).ClickAsync();
        await Expect(Page).ToHaveTitleAsync("Puzzle View");
        ...
        await Page.GetByLabel("Publish Time:", new() { Exact = true }).FillAsync("2022-02-02");
