...
[TestFixture]
public partial class PileTypeAdminPages : PageTest
{
    [Test]
    public async Task MainNavigation()
    {
        ...
        await Page.GetByTestId("pileTypeNavLink").ClickAsync();
        await Expect(Page).ToHaveTitleAsync("Pile Type Home");
        ...
        await Expect(Page).ToHaveTitleAsync("Pile Type View");
        await Page.GetByRole(AriaRole.Link, new() { Name = "Edit" }).ClickAsync();
        await Expect(Page).ToHaveTitleAsync("Pile Type Edit");
